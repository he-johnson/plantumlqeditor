...
void MainWindow::onReferenceGuide() {
    ...
    QFileInfo pdf(ExpandEnvironmentVariables("${PQE_HOME}/doc/PlantUML_Language_Reference_Guide.pdf"));
...
void MainWindow::readSettings(bool reload) {
    ...
    {
        // assistant.xml
        reloadAssistantXml(settings.value(SETTINGS_ASSISTANT_XML_PATH, ExpandEnvironmentVariables(SETTINGS_ASSISTANT_XML_DEFAULT_PATH)).toString());
