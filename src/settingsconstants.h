...
const QString SETTINGS_ASSISTANT_XML_DEFAULT_PATH = "${PQE_HOME}\\assistant\\assistant.xml";
...
const QString SETTINGS_CUSTOM_PLANTUML_PATH_DEFAULT = "${PQE_HOME}\\jar\\plantuml.jar";
const QString SETTINGS_CUSTOM_GRAPHVIZ_PATH_DEFAULT = "${PQE_HOME}\\graphviz\\bin\\dot.exe"; // %GRAPHVIZ_DOT%
#else
